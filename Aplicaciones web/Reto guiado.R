#En este reto guiado vamos a crear una aplicación interactiva con Shiny sobre el set de datos de diamantes que incluye R.
#Vamos a ir construyendo paso a paso cada una de las partes esenciales de una aplicación, enriqueciéndolas progresivamente desde la UI hasta el server.
library(shiny)
library(ggplot2)
